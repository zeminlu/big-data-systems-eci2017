In this folder you can find the solutions to both subwayPassengers and trafficFlow problems using Spark.
A script is included in each one for running the code. Spark code is in a .scala file.
